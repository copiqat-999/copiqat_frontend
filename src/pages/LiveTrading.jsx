import { liveTradingDataParagraph1, liveTradingDataParagraph2 } from "../data";
import RootNavbar from "../utilities/RootNavbar";
import liveTrading from "../assets/live.png";
        ...
        <section className="container mx-auto px-2 py-2 h-full flex flex-col gap-y-8">
            ...
            <div className="flex flex-col py-4 gap-y-2 w-full md:w-[70%] lg:w-[60%]">
                <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-white">
                    Live trading <span className="text-primary">Interface</span>
                </h1>
                ...
                <div className="flex flex-col md:flex-row-reverse items-start justify-between gap-12">
                    ...
                    <div className="flex flex-col gap-8">
                        <h2 className="text-white text-2xl md:text-3xl font-semibold">
                            {liveTradingDataParagraph1.header}
                        </h2>
                        <p className="text-sm text-pretty font-normal text-white">
                            {liveTradingDataParagraph1.paragraph1}
                        </p>
                        <p className="text-sm text-pretty font-normal text-white">
                            {liveTradingDataParagraph1.paragraph2}
                        </p>
                        <p className="text-sm text-pretty font-normal text-white">
                            {liveTradingDataParagraph1.paragraph3}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col w-full gap-y-8 py-4">
                <h2 className="text-white text-2xl md:text-3xl font-semibold">
                    {liveTradingDataParagraph2.header}
                </h2>
                <p className="text-sm text-pretty font-normal text-white">
                    {liveTradingDataParagraph2.paragraph}
                </p>
                <h2 className="text-white text-2xl md:text-3xl font-semibold">
                    {liveTradingDataParagraph2.header1}
                </h2>
                <p className="text-sm text-pretty font-normal text-white">
                    {liveTradingDataParagraph2.paragraph1}
                </p>
            </div>

            {/* CAT button */}
            <div className="w-full flex items-center justify-center pb-8">
                <button onClick={() => navigate('/vault')} className="w-full sm:w-[70%] md:w-[60%] lg:[w-50%] py-3 text-black text-sm font-semibold bg-primary rounded-lg cursor-pointer hover:scale-105 transition-all duration-300 ease-in">
                    Start trading
                </button>
            </div>
        </section>
